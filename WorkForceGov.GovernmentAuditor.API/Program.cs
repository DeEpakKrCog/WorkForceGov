...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "WorkForceGov — Government Auditor API", Version = "v1",
    ...
    c.AddSecurityDefinition("UserIdHeader", new OpenApiSecurityScheme {
        Name = "X-User-Id", Type = SecuritySchemeType.ApiKey, In = ParameterLocation.Header, Description = "Auditor User ID. Example: 6" });
...
app.UseSwagger();
app.UseSwaggerUI(c => { c.SwaggerEndpoint("/swagger/v1/swagger.json", "Government Auditor API v1"); c.RoutePrefix = string.Empty; c.DocumentTitle = "WorkForceGov — Government Auditor API"; });
