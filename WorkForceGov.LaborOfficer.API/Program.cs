...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "WorkForceGov — Labor Officer API", Version = "v1",
    ...
    c.AddSecurityDefinition("UserIdHeader", new OpenApiSecurityScheme {
        Name = "X-User-Id", Type = SecuritySchemeType.ApiKey, In = ParameterLocation.Header, Description = "Labor Officer User ID. Example: 4" });
