...
namespace WorkForceGovProject.Controllers
{
    ...
    public class EmployerController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetDashboard() => Ok(await _employer.GetDashboardAsync(GetUserId()));
        ...
        public async Task<IActionResult> Register([FromBody] WorkForceGovProject.Models.Employer model) {
        ...
        public async Task<IActionResult> UpdateProfile([FromBody] WorkForceGovProject.Models.Employer model) {
            var e = await _employer.GetByUserIdAsync(GetUserId());
            if (e==null) return NotFound(new{Message="Profile not found."});
            e.CompanyName=model.CompanyName; e.Industry=model.Industry; e.Address=model.Address;
            e.PhoneNumber=model.PhoneNumber; e.Website=model.Website; e.Description=model.Description;
        ...
        [SwaggerOperation(Summary="Upload employer document (triggers Compliance review)", Tags=new[]{"Documents"})]
        ...
        [SwaggerOperation(Summary="Update application status (Shortlisted/Rejected/Hired)", Tags=new[]{"Applications"})]
